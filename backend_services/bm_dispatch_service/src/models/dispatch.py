...
class Dispatch(Base):
    ...
    confirmed_by = Column(Integer, name="confirmedBy", nullable=True)
    ...
    rescheduled_at = Column(DateTime, nullable=True, name="rescheduledAt")
    ...
    fulfilled_by = Column(Integer, nullable=True, name="fulfilledBy")
